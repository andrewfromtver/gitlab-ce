...
./reg_new_runner.sh "gitlab-build-runner" "build" "$RUNNER_REG_TOKEN" "http://gitlab.vm"
echo "Registering  gitlab-test-runner ..."
./reg_new_runner.sh "gitlab-test-runner" "test" "$RUNNER_REG_TOKEN" "http://gitlab.vm"
echo "Registering  gitlab-deploy-runner ..."
./reg_new_runner.sh "gitlab-deploy-runner" "deploy" "$RUNNER_REG_TOKEN" "http://gitlab.vm"
echo "###############################################################"
